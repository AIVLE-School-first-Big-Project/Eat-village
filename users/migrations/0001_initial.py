# Generated by Django 3.0.7 on 2022-04-23 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipeid', models.ForeignKey(db_column='recipeID', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Recipedata')),
                ('userid', models.ForeignKey(db_column='userID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=recipeboard.utils.upload_image)),
                ('time', models.DateTimeField()),
                ('boardid', models.ForeignKey(db_column='boardID', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Recipeboard')),
            ],
            options={
