    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.CharField(choices=[('요리재료게시판', '요리재료게시판'), ('자유게시판', '자유게시판')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boardid', models.ForeignKey(db_column='boardid', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Recipeboard')),
                ('userid', models.ForeignKey(db_column='userID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='recipeboard/', verbose_name='')),
                ('time', models.DateTimeField()),
                ('boardid', models.ForeignKey(db_column='boardID', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Recipeboard')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', models.CharField(max_length=500)),
                ('time', models.DateTimeField()),
                ('boardid', models.ForeignKey(db_column='boardID', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Communityboard')),
                ('userid', models.ForeignKey(db_column='userID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('photoid', models.AutoField(db_column='photoID', primary_key=True, serialize=False)),
                ('image', models.ImageField(null=True, upload_to='communityboard/', verbose_name='')),
                ('time', models.DateTimeField()),
                ('boardid', models.ForeignKey(db_column='boardID', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Communityboard')),
            ],
            options={
